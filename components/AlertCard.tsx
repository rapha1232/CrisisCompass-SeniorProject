...
const AlertCard = ({ broadcast, editable = false }: AlertProps) => {
  ...
  return (
    <div className="relative flex w-11/12 flex-col items-start justify-between rounded-[10px] bg-dark-400 p-9 sm:px-11">
      ...
      <div className="flex items-center gap-3 max-sm:flex-wrap max-sm:justify-start">
        <Link
          ...
          className="text-blue-500 visited:text-purple-500 hover:text-purple-500"
        >
          More Details
        </Link>
      </div>
      <div className="absolute right-2 top-2 h-8 w-16">
        <Badge
          className={cn("size-full border text-white flex both-center", {
