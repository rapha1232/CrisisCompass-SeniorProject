...
function doRequest(_ref) {
  ...
  const _ref$body = _ref.body;
  const body = _ref$body === void 0 ? null : _ref$body;
  const _ref$headers = _ref.headers;
  const headers = _ref$headers === void 0 ? {} : _ref$headers;
  const options = {
    method,
    headers,
  };
    ...
    createClass(DeviceStateStore, [
      {
        ...
        value: function connect() {
          ...
          return new Promise(function (resolve, reject) {
            const request = indexedDB.open(_this._dbName);
      ...
      },
      {
        key: "_readProperty",
        value: (function () {
          const _readProperty2 = asyncToGenerator(
            /* #__PURE__ */
      ...
      },
      {
        key: "_writeProperty",
        value: (function () {
          const _writeProperty2 = asyncToGenerator(
            /* #__PURE__ */
...
self.PusherPushNotifications = {
  ...
  reportEvent: (function () {
    const _reportEvent = asyncToGenerator(
      /* #__PURE__ */
...
self.addEventListener("push", function (e) {
  ...
  const customerPayload = objectSpread({}, payload);
    ...
    (function () {
      const _ref2 = asyncToGenerator(
        ...
        regenerator.mark(function _callee2(payloadFromCallback) {
          let hideNotificationIfSiteHasFocus, title, body, icon, options;
...
self.addEventListener("notificationclick", function (e) {
  const pusher = e.notification.data.pusher;
